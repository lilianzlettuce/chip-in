...
export default function Home() {
  ...
  const getHouseholdInfo = async () => {
    ...
    try {
      ...
      const url = `${SERVER_URL}/household/${householdId}`;
    ...
    try {
      const url = `${SERVER_URL}/household/members/${householdId}`;
      const response = await fetch(url);
      const data = await response.json();
      if (response.ok) {
  ...
  const handleLeave = async () => {
    try {
      ...
      const url = `${SERVER_URL}/household/leave/${householdId}`;
  ...
  const getPurchaseHistory = async () => {
    ...
    try {
      // GET request to server
      const url = `${SERVER_URL}/household/${householdId}/purchaseHistory`;
      const response = await fetch(url);
      const data = await response.json();
      if (response.ok) {
    ...
    try {
      // GET request to server
      const url = `${SERVER_URL}/household/${householdId}/expenditurePerMonth`;
      const response = await fetch(url);
      if (response.ok) {
        const data = await response.json();
    ...
    try {
      // GET request to server
      const url = `${SERVER_URL}/household/${householdId}/expensesByCategory`;
      const response = await fetch(url);
      if (response.ok) {
        const data = await response.json();
    ...
    try {
      // GET request to server
      const url = `${SERVER_URL}/household/${householdId}/expensesByItem`;
      const response = await fetch(url);
      if (response.ok) {
        const data = await response.json();
